...
* [Week10 - File System and Blick I/O](#Week10-File-System-and-Block-IO)
...
Kernel Process 為了效能要求連續的 phsical memory，User Process 則可以讓 physical memory 分散
...
Linux Kernel 採用 Buddy System 進行 Phyiscs memory 的管理
...
在 physics memory 管理上因為還是有速度上的差距，因此另外還有使用 ZONE 的結構去管理不同速度的 memory 供不同情境下使用
...
## Week10 File System and Block IO
